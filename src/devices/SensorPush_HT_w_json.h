...
/* R""""(
{
   ...
   "model_id": "HT_w",
   "tag": "0101",
   "condition": ["uuid", "index", 0, "ef090000-11d6-42ba-93b8-9dd7ec090ab0", "&", "manufacturerdata", "index", 0, "04"],
   "properties": {
      ".cal": {
